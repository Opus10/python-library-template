...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    PATH=/code/.venv/bin:/opt/conda/envs/py312/bin:/opt/conda/envs/py311/bin:/opt/conda/envs/py310/bin:/opt/conda/envs/py39/bin:/opt/conda/envs/py38/bin:/opt/conda/envs/essential/bin:/opt/circleci/.poetry/bin:$PATH
